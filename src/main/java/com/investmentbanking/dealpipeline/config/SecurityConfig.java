...
//         configuration.setAllowedOrigins(List.of("http://3.7.66.205",
//                                                 "http://localhost:3000",
//                                                 "http://localhost:4200"));
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            // Allow ALL requests (TEMP – frontend connectivity)
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**").permitAll()
...
//             // ❗ TEMP: Allow all requests (for frontend-backend connectivity)
//             .authorizeHttpRequests(auth -> auth
//                 .anyRequest().permitAll()
//             )
